...
function createLocalBrowserUpload(file, { bucket, storagePath }) {
  console.warn("Supabase Storage is not configured. Using a temporary browser-local preview URL for this upload.");
  return {
    bucket,
    storagePath,
